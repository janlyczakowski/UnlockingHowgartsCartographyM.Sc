...
import stairsIcon from '../../resources/svg/fourth floor/inaccessible/Stairs.svg';
import inaccessibleTableIcon from '../../resources/svg/fourth floor/inaccessible/Table.svg';
import inaccessibleShelfIcons from '../../resources/svg/fourth floor/inaccessible/Shelf.svg';

import accessibleTableIcon from '../../resources/svg/fourth floor/accessible/Table.svg';
import rampIcon from '../../resources/svg/fourth floor/accessible/Ramp.svg';
import elevatorIcon from '../../resources/svg/fourth floor/accessible/Elevator.svg';
import accessibleShelfIcons from '../../resources/svg/fourth floor/accessible/Shelf.svg';

import pdfFile from '../../resources/pdf/FeatureDescription.pdf';

function FourthFloorLegend(props) {
    const { onScrollHandler } = props;
    const legendCtx = useContext(LegendContext);

    const onChangenHandler = (event) => {
        legendCtx.isFeaturesAccessibleFourthFloor(event.target.value);
    };
    ...
    const accessibleLegend = [
        ...
        {
            icon: accessibleShelfIcons,
            iconAlt: 'Accessible shelf icon',
            name: 'Shelf',
            description: ['Height-adjustable to enable reach from different levels.'],
            descriptionOpen: false
        },
        {
            ...
            name: 'Table',
            description: ['Height-adjustable to suit a variety of wheelchair types.'],
            descriptionOpen: false
        }
    ];
    const inAccessibleLegend = [
        ...
        {
            icon: inaccessibleShelfIcons,
            iconAlt: 'Inaccessible shelf icon',
            name: 'Shelf',
            description: '',
            descriptionOpen: false
        },
        ...
        <div className={styles.wrapper} onScroll={(e) => onScrollHandler(e)}>
            ...
            <div className={styles.legend}>
                <p className={styles.description}>
                    The Library is a representative example of how libraries can be transformed in
                    our case study.
                </p>
                    ...
                    <div className={styles.button}>
                        <div className={styles.input_wrapper}>
                            ...
                            <input
                                ...
                                checked={legendCtx.featuresAccessibleFourthFloor === 'inaccessible'}
                            />
                    ...
                    <div className={styles.button}>
                        <div className={styles.input_wrapper}>
                            ...
                            <input
                                ...
                                onChange={onChangenHandler}
                                checked={legendCtx.featuresAccessibleFourthFloor === 'accessible'}
                            />
                            <div className={styles.cross} />
                        </div>
                    </div>
                ...
                <div className={styles.legend_content}>
                    <Legend
                        legendContent={
                            legendCtx.featuresAccessibleFourthFloor === 'accessible'
                                ? accessibleLegend
                                : inAccessibleLegend
                        }
                    />
...
export default FourthFloorLegend;
